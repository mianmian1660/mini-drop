...
type ContinuousParquetBlockFile struct {
	...
	PartIndex   int       `gorm:"column:part_index" json:"part_index"`
...
type ContinuousParquetBlockMember struct {
	...
	SourceKind  string    `gorm:"column:source_kind;size:16" json:"source_kind"`
	// SourceRef: batch 为 bid，window 为 window_id/时间窗，block 为来源 block_id。
	SourceRef   string    `gorm:"column:source_ref;size:128" json:"source_ref"`
