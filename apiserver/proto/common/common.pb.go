...
type HostStats struct {
	...
	CpuPercent        float64 `protobuf:"fixed64,1,opt,name=cpu_percent,json=cpuPercent,proto3" json:"cpu_percent,omitempty"`                          // 整机 CPU 使用率 0-100
	CpuAvailable      bool    `protobuf:"varint,2,opt,name=cpu_available,json=cpuAvailable,proto3" json:"cpu_available,omitempty"`                     // CPU 是否可用（/proc/stat 读取失败=false）
	MemoryUsedBytes   uint64  `protobuf:"varint,3,opt,name=memory_used_bytes,json=memoryUsedBytes,proto3" json:"memory_used_bytes,omitempty"`          // 已用内存（字节）
	MemoryTotalBytes  uint64  `protobuf:"varint,4,opt,name=memory_total_bytes,json=memoryTotalBytes,proto3" json:"memory_total_bytes,omitempty"`       // 内存总量（字节）
	MemoryPercent     float64 `protobuf:"fixed64,5,opt,name=memory_percent,json=memoryPercent,proto3" json:"memory_percent,omitempty"`                 // 内存占用率 0-100
	MemoryAvailable   bool    `protobuf:"varint,6,opt,name=memory_available,json=memoryAvailable,proto3" json:"memory_available,omitempty"`            // 内存是否可用（/proc/meminfo 读取失败=false）
	DiskUsedBytes     uint64  `protobuf:"varint,7,opt,name=disk_used_bytes,json=diskUsedBytes,proto3" json:"disk_used_bytes,omitempty"`                // 磁盘已用（字节）
	DiskTotalBytes    uint64  `protobuf:"varint,8,opt,name=disk_total_bytes,json=diskTotalBytes,proto3" json:"disk_total_bytes,omitempty"`             // 磁盘总量（字节）
	DiskPercent       float64 `protobuf:"fixed64,9,opt,name=disk_percent,json=diskPercent,proto3" json:"disk_percent,omitempty"`                       // 磁盘占用率 0-100
	DiskAvailable     bool    `protobuf:"varint,10,opt,name=disk_available,json=diskAvailable,proto3" json:"disk_available,omitempty"`                 // 磁盘是否可用（statvfs 失败=false）
	DiskMount         string  `protobuf:"bytes,11,opt,name=disk_mount,json=diskMount,proto3" json:"disk_mount,omitempty"`                              // 逻辑挂载点标签，如 "/"
	CollectedAtUnixMs int64   `protobuf:"varint,12,opt,name=collected_at_unix_ms,json=collectedAtUnixMs,proto3" json:"collected_at_unix_ms,omitempty"` // 采集时间（Unix 毫秒）
}
...
func (x *HostStats) GetCpuAvailable() bool {
	if x != nil {
...
func (x *HostStats) GetMemoryPercent() float64 {
	if x != nil {
...
func (x *HostStats) GetMemoryAvailable() bool {
	if x != nil {
...
func (x *HostStats) GetDiskPercent() float64 {
	if x != nil {
...
func (x *HostStats) GetDiskAvailable() bool {
	if x != nil {
...
func (x *HostStats) GetDiskMount() string {
	if x != nil {
		return x.DiskMount
	}
	return ""
...
func (x *HostStats) GetCollectedAtUnixMs() int64 {
	if x != nil {
...
var file_common_proto_common_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x6d, 0x6d, 0x22, 0xe9,
	0x03, 0x0a, 0x09, 0x48, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x1f, 0x0a, 0x0b,
	0x63, 0x70, 0x75, 0x5f, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x01, 0x52, 0x0a, 0x63, 0x70, 0x75, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a,
	0x0d, 0x63, 0x70, 0x75, 0x5f, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x63, 0x70, 0x75, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62,
	0x6c, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x75, 0x73, 0x65,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0xff, 0x01, 0x0a,
	0x09, 0x43, 0x6f, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e,
	...
	0x4b, 0x65, 0x79, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x0f, 0x73, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6f, 0x6e, 0x12, 0x22, 0x0a, 0x0c, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65,
	0x54, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x65, 0x78, 0x70, 0x69,
	0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x53, 0x73, 0x6c,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x75, 0x73, 0x65, 0x53, 0x73, 0x6c, 0x42, 0x2d,
